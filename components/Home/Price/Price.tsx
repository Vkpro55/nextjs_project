...
export default function Price() {
  return <div className="mt-16 mb-16">
    ...
    <div className="w-[80%] mx-auto mt-16 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <PriceCard type="Basic" price="199" isRecommended={false}/>
        <PriceCard type="Standard" price="399" isRecommended={true}/>
        <PriceCard type="Extended" price="799" isRecommended={false}/>
    </div>
  </div>;
}
