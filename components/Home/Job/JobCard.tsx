...
export default function JobCard({ job }: Props) {
  return (
    <div className="border-[1.5px] border-gray-300 dark:border-gray-700 p-6 rounded-lg relative">
      {/* icon div */}
      <div className="w-7 h-7 cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-800 items-center justify-center transition-all duration-200 rounded-full flex flex-col absolute top-4 right-4">
      ...
      <div className="flex items-center space-x-4 mt-3">
        <div className="px-4 py-1 bg-blue-600/30 dark:bg-blue-950/30 rounded-full text-xs text-blue-700 dark:text-blue-300 text-center">
          {job.jobType}
        </div>
        <div
          className={`px-4 py-1 rounded-full text-xs text-center
  ${
    job.urgency === "Urgent"
